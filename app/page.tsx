...
export default function FashionBoutiqueDigitalReceipt() {
    ...
    current: {
      ...
      items: [
        ...
        },
        {
          ...
          description: "Women's A-Line Midi Dress with Floral Print",
          price: 2499.0,
          quantity: 1,
        ...
        },
        {
          ...
          description: "Men's Genuine Leather Oxford Shoes",
          price: 3999.0,
          quantity: 1,
      ...
      subtotal: 7706.78, // Base amount
      gst: 1387.22, // Total GST (18%)
      total: 9094.0,
    },
    hist1: {
      id: "FB200725192286448317",
      date: "20-07-2025",
      time: "19:30:15",
      ...
      items: [
        {
          id: 0,
          name: "Denim Jacket",
          description: "Women's Classic Blue Denim Jacket",
          price: 1899.0,
          quantity: 1,
    ...
    hist2: {
      ...
      items: [
        ...
        },
        {
          id: 1,
          name: "Silk Scarf",
          description: "Women's Premium Silk Printed Scarf",
          price: 899.0,
          quantity: 1,
  ...
  const transactionHistory = [
    { id: "current", branch: "Fashion Boutique, Downtown", date: "21-08-2025", amount: 9094.0 },
    { id: "hist1", branch: "Fashion Boutique, Downtown", date: "20-07-2025", amount: 1899.0 },
    { id: "hist2", branch: "Fashion Boutique, Downtown", date: "15-07-2025", amount: 2498.0 },
  ]
  ...
  const handleShare = async () => {
    const shareData = {
      title: "Shop at Fashion Boutique - Premium Fashion for Everyone!",
      text: `Hey! I just shopped at Fashion Boutique and found amazing fashion items!

Use my referral code: FB${Math.random().toString(36).substr(2, 6).toUpperCase()}

Experience their premium collection of men's and women's fashion!
...
https://www.rdep.io/`,
    ...
    if (isInIframe) {
      ...
      const sharingUrls = {
        ...
        telegram: `https://t.me/share/url?url=https://www.rdep.io/&text=${encodedText}`,
    ...
    ">
      ...
      ">
        <div style="
          ...
          padding-bottom: 16px;
        ">
          <h3 style="margin: 0; color: #2563eb; font-size: 18px;">Share Referral Link</h3>
  ...
  const handleEmailReceipt = () => {
    const subject = encodeURIComponent(`Fashion Boutique Receipt - ${currentReceipt.id}`)
    const body = encodeURIComponent(`Dear Customer,

Thank you for shopping at Fashion Boutique!
...
We hope you love your new fashion items!

Best regards,
Fashion Boutique Team
      `)
    window.open(`mailto:sagar.p@proenx.com?subject=${subject}&body=${body}`, "_blank")
  }
...
<head>
    <meta charset="UTF-8">
    <title>Fashion Boutique Receipt</title>
    <style>
...
<body>
    ...
    <div class="receipt-header">
      <div class="logo-section">
        <div class="logo-img">
          <img src="https://www.rdep.io/wp-content/uploads/2023/03/RDEP-cropped.png" alt="Fashion Boutique Logo">
        </div>
        <div class="company-info">
          <h1>Fashion Boutique</h1>
          <p>Premium Fashion Store<br>
          Mumbai, Maharashtra<br>
          Phone: +91 96209 21294<br>
          GSTIN: 27AADCB6432B1Z0</p>
        </div>
      </div>
      <div class="bill-info">
    ...
    <div class="customer-section">
      <h3>Customer: Aaditya</h3>
      <p>Thank you for choosing Fashion Boutique - Your Style Destination!</p>
    </div>
        ...
        ${currentReceipt.items
          ...
          <tr>
            <td>
              ...
              ${item.sku ? `<div class="item-specs">SKU: ${item.sku} | Size: ${item.size} | Gender: ${item.gender}</div>` : ""}
            </td>
            <td>${item.quantity}</td>
            <td>Piece</td>
    ...
    <div class="totals-section">
      ...
      <div class="totals-table">
        ...
        <div>GST (18%): <strong>₹${currentReceipt.gst.toFixed(2)}</strong></div>
    ...
    <!-- Footer -->
    <div class="footer">
      <p><strong>Thank you for shopping at Fashion Boutique!</strong></p>
      <p>Visit us online at www.rdep.io or call +91 96209 21294</p>
    ...
    link.href = url
    link.download = `Fashion_Boutique_Receipt_${currentReceipt.id}.html`
      ...
      <div className="w-full max-w-md mx-auto bg-white shadow-lg relative">
        <div className="flex flex-col w-full gap-4 pb-6 px-4">
                  ...
                  <CarouselContent>
                    <CarouselItem>
                      <div className="w-full">
                        <div className="relative w-full">
                          <Image
                            src="https://www.lavieworld.com/cdn/shop/files/1920x643_D_main_1728x.jpg?v=1753868743%201728w%20579h"
                    ...
                    <CarouselItem>
                      <div className="w-full">
                        <div className="relative w-full">
                          <Image
                            src="https://www.lavieworld.com/cdn/shop/files/1920x643_D_Sling_1728x.jpg?v=1750936683%201728w%20579h"
                            alt="Fashion Collection - Upto 50% Off"
                            width={800}
                            height={0}
                            sizes="100vw"
                            className="w-full h-auto object-contain"
          ...
          <Card className="border-none shadow-md">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <div className="flex items-center space-x-2">
                <Badge variant="outline" className="text-xs font-normal border-[#2563eb] text-[#2563eb]">
                  Tax Invoice
                </Badge>
              </div>
              <div className="flex space-x-3">
                <Button
                  ...
                  variant="ghost"
                  size="icon"
                  className="h-9 w-9 text-[#2563eb] hover:bg-[#2563eb]/10"
            ...
            <CardContent className="pb-2">
              <div className="mb-4">
                ...
                <div className="text-base font-semibold text-[#2563eb]">{currentReceipt.id}</div>
              </div>
              ...
              <div className="mt-6">
                <div className="flex flex-col items-center">
                  ...
                  <h2 className="text-lg font-semibold text-[#2563eb]">Fashion Boutique</h2>
                  <p className="text-xs text-gray-500 text-center">Premium Fashion Store</p>
                  <Button
                    variant="ghost"
                    size="sm"
                    className="mt-1 h-6 text-xs text-[#2563eb] hover:bg-[#2563eb]/10"
                    ...
                    <div className="text-center animate-in fade-in-50 duration-300">
                      ...
                      <div className="flex flex-col items-center mt-2">
                        <div className="flex items-center text-xs text-gray-500">
                          <span>Phone: +91 96209 21294</span>
                        </div>
                        <div className="flex items-center text-xs text-gray-500">
                          <span>GSTIN: 27AADCB6432B1Z0</span>
                        </div>
                      </div>
                    </div>
                  )}
              ...
              <div className="mt-4 bg-[#2563eb]/10 border-l-4 border-[#2563eb] px-4 py-2 rounded-r-lg flex items-center">
                <User2 className="h-5 w-5 mr-2 text-[#2563eb]" />
                <h3 className="text-lg font-medium text-[#2563eb]">Hello Aaditya!</h3>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-none shadow-md">
            <CardHeader className="pb-2">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold flex items-center text-[#2563eb]">
                  <ShoppingBag className="mr-2 h-5 w-5 text-[#2563eb]" />
                  Purchase Details
                </h3>
            ...
            <CardContent>
                  ...
                  <div key={product.id} className="border rounded-lg overflow-hidden">
                    ...
                    >
                      <div className="flex items-center flex-1">
                        <ChevronRight
                          className={`h-4 w-4 mr-2 text-[#2563eb] transition-transform duration-200 ${
                            expandedProducts.includes(product.id) ? "rotate-90" : ""
                          }`}
                        />
                        <div className="flex-1">
                          <span className="font-medium text-[#2563eb]">{product.name}</span>
                      ...
                      <div className="bg-white p-4 space-y-4 border-t animate-in slide-in-from-top-5 duration-300">
                        <div className="bg-gray-50 rounded-lg p-3">
                          <div className="flex items-center mb-3">
                            <Package className="h-4 w-4 mr-2 text-[#2563eb]" />
                            <span className="font-medium text-[#2563eb]">Product Details & GST</span>
                          </div>
                          ...
                          <div className="space-y-2 text-sm">
                            ...
                            <div className="flex justify-between items-start">
                              ...
                              <span className="font-medium text-right ml-4">{product.size}</span>
                            </div>
                            {product.gender && (
                              <div className="flex justify-between items-start">
                            ...
                            <div className="border-t pt-2 mt-3">
                              ...
                              <div className="flex justify-between items-start">
                                <span className="text-gray-600 flex-shrink-0">GST (18%)</span>
              ...
              <div className="mt-6 space-y-2 border-t pt-4">
                ...
                <div className="flex justify-between text-sm font-medium">
                  ...
                  <span className="text-lg text-[#2563eb] font-bold">₹{currentReceipt.total.toFixed(2)}</span>
                </div>
              </div>
              <div className="mt-6">
                <div className="flex items-center mb-2">
                  <CreditCard className="h-5 w-5 mr-2 text-[#2563eb]" />
                  <h4 className="text-sm font-medium">Payment Method</h4>
                </div>
                <div className="flex justify-between items-center bg-gray-50 p-3 rounded-lg">
                  <div className="flex items-center">
                    <Wallet className="h-5 w-5 mr-2 text-[#2563eb]" />
                    <span className="text-[#2563eb] font-medium">Card Payment</span>
                  </div>
                  <span className="font-medium text-[#2563eb]">₹{currentReceipt.total.toFixed(2)}</span>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-none shadow-md overflow-hidden">
            <CardHeader className="pb-2 bg-gradient-to-r from-[#2563eb]/10 to-[#2563eb]/5">
              <h3 className="text-lg font-semibold flex items-center text-[#2563eb]">
                <ThumbsUp className="mr-2 h-5 w-5 text-[#2563eb]" />
            ...
            <CardContent className="p-4">
              {feedbackSubmitted ? (
                <div className="text-center py-4">
                  ...
                  <h4 className="text-sm font-semibold text-[#2563eb] mb-1">Thank you for your feedback!</h4>
                ...
                <Button
                  ...
                  variant="outline"
                  className="w-full border-[#2563eb] text-[#2563eb] hover:bg-[#2563eb]/10 bg-transparent"
          ...
          <Card className="border-none shadow-md overflow-hidden">
            <CardHeader className="pb-2 bg-gradient-to-r from-[#2563eb]/10 to-[#2563eb]/5">
              <h3 className="text-lg font-semibold flex items-center text-[#2563eb]">
                <Share2 className="mr-2 h-5 w-5 text-[#2563eb]" />
                Refer a Friend
              </h3>
            </CardHeader>
            <CardContent className="p-4">
              <div className="flex items-center bg-white p-3 rounded-lg border border-[#2563eb]/20">
                <div className="mr-3 bg-[#2563eb]/10 p-2 rounded-full">
                  <Gift className="h-6 w-6 text-[#2563eb]" />
                </div>
                <div>
                  <p className="text-sm">
                    Refer a friend and both of you earn{" "}
                    <span className="font-medium text-[#2563eb]">500 Loyalty Points</span>
                  </p>
                </div>
              </div>
              <Button
                variant="outline"
                className="w-full mt-3 border-[#2563eb] text-[#2563eb] hover:bg-[#2563eb]/10 bg-transparent"
                onClick={handleShare}
              >
                Share Referral Link
              </Button>
            ...
            <CardHeader className="pb-0 pt-0 px-0">
              <Tabs defaultValue="loyalty" className="w-full">
                <TabsList className="w-full grid grid-cols-3 rounded-none h-12 bg-gray-100">
                  <TabsTrigger
                    value="loyalty"
                    className="rounded-none data-[state=active]:bg-white data-[state=active]:text-[#2563eb] data-[state=active]:border-b-2 data-[state=active]:border-[#2563eb] transition-all"
                  >
                    Loyalty
                  </TabsTrigger>
                  <TabsTrigger
                  ...
                  <div className="flex flex-col">
                    <div className="grid grid-cols-3 gap-4 mb-6">
                      <div className="flex flex-col items-center p-3 bg-white rounded-lg border border-gray-100 shadow-sm">
                        <div className="w-10 h-10 rounded-full bg-[#2563eb]/10 flex items-center justify-center mb-2">
                          <div className="text-[#2563eb] font-bold">✨</div>
                        </div>
                        <span className="text-xl font-bold text-[#2563eb]">1,250</span>
                      ...
                      <div className="flex flex-col items-center p-3 bg-white rounded-lg border border-gray-100 shadow-sm">
                        ...
                        <span className="text-lg font-bold text-[#2563eb]">₹850</span>
                      ...
                      <div className="mt-4 pt-4 border-t border-dashed">
                        <div className="space-y-2 text-sm">
                          <div className="flex items-center text-green-600">
                            ...
                            <span>Exclusive discounts on premium fashion</span>
                          </div>
                          <div className="flex items-center text-green-600">
                            <span className="mr-2">✓</span>
                          ...
                          <div className="flex items-center text-green-600">
                            <span className="mr-2">✓</span>
                            <span>Free alterations and styling advice</span>
                          </div>
                          <div className="flex items-center text-green-600">
                            <span className="mr-2">✓</span>
                ...
                <TabsContent value="profile" className="mt-0 p-4">
                  {profileUpdateSuccess ? (
                    <div className="text-center py-8">
                      ...
                      <h3 className="text-lg font-semibold text-[#2563eb] mb-2">Profile Updated Successfully!</h3>
                    ...
                    <>
                      <div className="text-center mb-4 bg-[#2563eb]/10 p-3 rounded-lg">
                      ...
                      <div className="space-y-4">
                        ...
                        <Button
                          className="w-full bg-[#2563eb] hover:bg-[#2563eb]/90 text-white mt-2"
                    ...
                    <CarouselContent>
                      <CarouselItem>
                        <div className="p-4">
                          <div className="relative w-full">
                            <Image
                              src="https://www.lavieworld.com/cdn/shop/files/1920x643_D_New_arrivals_collection_0bc261a6-20c3-4026-8cb8-33f1e105fcf3_1728x.jpg"
                              alt="New Arrivals"
                              width={800}
                              height={0}
                              sizes="100vw"
                          ...
                          <h3 className="font-medium mt-2 text-[#2563eb]">New Arrivals</h3>
                          <p className="text-sm text-gray-500 mt-2">
                            Latest fashion trends - Shop the newest collection
                          </p>
                        </div>
                      </CarouselItem>
                      <CarouselItem>
                        <div className="p-4">
                          <div className="relative w-full">
                            <Image
                              src="https://www.lavieworld.com/cdn/shop/files/1920x643_D_FS_collection_1728x.jpg"
                              alt="Bestsellers"
                              width={800}
                              height={0}
                              sizes="100vw"
                          ...
                          <h3 className="font-medium mt-2 text-[#2563eb]">Upto 50% Off</h3>
                          <p className="text-sm text-gray-500 mt-2">Grab your favorites before they are gone!</p>
                        </div>
                      </CarouselItem>
                    </CarouselContent>
                    <div className="absolute bottom-1 left-0 right-0 flex justify-center gap-1">
                      {[...Array(totalSlides)].map((_, index) => (
                        <button
                          ...
                          className={`h-2 w-2 rounded-full transition-all duration-300 ${
                            currentSpotlightSlide === index ? "bg-[#2563eb]" : "bg-[#2563eb]/30"
                          }`}
                        />
                      ))}
                    </div>
          ...
          <Card className="border-none shadow-md overflow-hidden">
            <CardHeader className="pb-2 bg-gradient-to-r from-[#2563eb]/10 to-[#2563eb]/5">
              <h3 className="text-lg font-semibold flex items-center text-[#2563eb]">
                <Send className="mr-2 h-5 w-5 text-[#2563eb]" />
                Contact Us
              </h3>
            </CardHeader>
            <CardContent className="p-4">
              <div className="grid grid-cols-3 gap-3">
                <button
                  ...
                  className="bg-white border border-gray-100 rounded-lg shadow-sm p-3 flex flex-col items-center transition-all hover:border-[#2563eb]/30 hover:shadow"
                >
          ...
          <Card className="border-none shadow-md overflow-hidden">
            <CardHeader className="pb-2 bg-gradient-to-r from-[#2563eb]/10 to-[#2563eb]/5">
              <h3 className="text-lg font-semibold flex items-center text-[#2563eb]">
                <ExternalLink className="mr-2 h-5 w-5 text-[#2563eb]" />
                Follow Us
              </h3>
            </CardHeader>
            <CardContent className="p-4">
              <div className="flex justify-around">
                <div className="flex flex-col items-center">
                  <button onClick={() => handleSocialLink("https://instagram.com")} className="mb-1">
                    <div className="h-12 w-12">
                      <Image
                        src="http://upload.wikimedia.org/wikipedia/commons/thumb/e/e7/Instagram_logo_2016.svg/1200px-Instagram_logo_2016.svg.png"
                        alt="Instagram"
                        width={48}
                        height={48}
                        className="object-contain"
                ...
                <div className="flex flex-col items-center">
                  <button onClick={() => handleSocialLink("https://facebook.com")} className="mb-1">
                    <div className="h-12 w-12">
                      <Image
                ...
                <div className="flex flex-col items-center">
                  <button onClick={() => handleSocialLink("https://www.rdep.io")} className="mb-1">
                    <div className="h-12 w-12">
                      <Image
          ...
          <Card className="border-none shadow-md overflow-hidden">
            <CardHeader className="pb-2 bg-gradient-to-r from-[#2563eb]/10 to-[#2563eb]/5">
              <h3 className="text-lg font-semibold flex items-center text-[#2563eb]">
                <FileText className="mr-2 h-5 w-5 text-[#2563eb]" />
                Terms and Conditions
              </h3>
            </CardHeader>
            <CardContent className="p-4">
              <Button
                variant="ghost"
                size="sm"
                className="w-full flex items-center justify-between text-[#2563eb] hover:bg-[#2563eb]/10"
              ...
              {showTerms && (
                <div className="text-sm text-gray-600 mt-2 space-y-2 animate-in fade-in-50 duration-300">
                  <ol className="list-decimal pl-5 space-y-2">
                    <li>All purchases are subject to Fashion Boutique's standard terms and conditions.</li>
                    <li>
                      Returns and exchanges must be made within 15 days of purchase with original tags, packaging and
                      receipt.
                    </li>
                    <li>Prices include GST where applicable. GST is calculated at 18% on fashion items.</li>
                    <li>Fashion Boutique is not responsible for personal belongings left unattended in the store.</li>
                    <li>
                      Loyalty program benefits are subject to separate terms and conditions available at www.rdep.io.
                    </li>
                    ...
                    <li>Store timings: 10:00 AM to 10:00 PM (Monday to Sunday).</li>
                    <li>Alterations are available for an additional charge and are final sale.</li>
                    <li>Sale items are final sale and cannot be returned or exchanged unless defective.</li>
                  </ol>
                  <div className="mt-4 pt-4 border-t border-dashed">
                    <h4 className="font-medium mb-1">Customer Care</h4>
                    <p className="text-xs">
                      For any queries regarding your purchase, please contact our customer care team on +91 96209 21294
                      or visit www.rdep.io.
                    </p>
                  </div>
                </div>
              )}
          ...
          <div className="absolute inset-0 bg-black/50 flex items-start justify-center z-50 animate-in fade-in-0 duration-300 px-4">
            ...
            >
              <div className="flex justify-between items-center p-4 border-b">
                <h3 className="text-lg font-semibold text-[#2563eb]">How was your shopping experience?</h3>
              ...
              <div className="p-4 border-t">
                <Button className="w-full bg-[#2563eb] hover:bg-[#2563eb]/90 text-white" onClick={handleFeedbackSubmit}>
                  Submit Feedback
                </Button>
              </div>
            </div>
        ...
        {showTransactionHistory && (
          <div className="absolute inset-0 bg-black/50 flex items-start justify-center z-50 animate-in fade-in-0 duration-300 px-4">
            ...
            >
              <div className="flex justify-between items-center p-4 border-b bg-[#2563eb] text-white">
                ...
                <Button
                  variant="ghost"
                  size="icon"
                  className="h-8 w-8 text-white hover:bg-[#2563eb]/80"
                ...
                <div className="space-y-3">
                  {transactionHistory.map((transaction) => (
                    <button
                      ...
                      className="w-full flex items-center p-3 bg-white border border-gray-100 rounded-lg shadow-sm hover:border-[#2563eb]/30 transition-all cursor-pointer"
                    >
                      ...
                      <div className="font-semibold text-[#2563eb]">₹{transaction.amount.toFixed(2)}</div>
                    </button>
                  ))}
                </div>
              </div>
